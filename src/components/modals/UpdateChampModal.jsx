...
function UpdateChampModal({ isOpen, onResolve, onReject,champ }) {
  ...
  const defaultValues = {nom: champ?.nom, user: '', superficie: champ.superficie};
...
export default create(UpdateChampModal)